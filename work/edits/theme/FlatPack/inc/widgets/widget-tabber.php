 ...
 * Tabber Widget
 */
class themefurnace_Tabber_Widget extends WP_Widget {


    /** constructor -- name this the same as the class above */
    function themefurnace_Tabber_Widget() {
...
function themefurnace_Tabber_Widget_Loader() {
    register_widget("themefurnace_Tabber_Widget");
}
add_action('widgets_init', 'themefurnace_Tabber_Widget_Loader');
?>
